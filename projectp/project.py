...
dairy = ["milk", "cheese", "yogurt", "butter", "cream", "sour cream", "cottage cheese", "whipped cream", "cheddar", "mozzarella", "parmesan", "swiss", "gouda", "brie", "feta", "cream cheese", "ricotta", "blue cheese", "goat cheese", "mascarpone", "provolone", "ghee", "buttermilk", "evaporated milk", "condensed milk"]
spices = ["cinnamon", "turmeric", "ginger", "cumin", "paprika", "coriander", "nutmeg", "cloves", "cardamom", "garlic powder", "onion powder", "chili powder", "oregano", "thyme", "rosemary", "bay leaf", "cayenne pepper", "black pepper", "white pepper", "red pepper flakes", "saffron", "mustard seeds", "fenugreek", "allspice", "star anise", "fennel seeds", "vanilla", "celery salt", "dill", "tarragon", "marjoram", "clove", "caraway seeds", "curry powder", "garam masala", "pumpkin pie spice"]
alcohol = ["beer", "wine", "whiskey", "vodka", "rum", "tequila", "gin", "brandy", "champagne", "cocktail", "martini", "margarita", "mojito", "sake", "scotch", "bourbon", "cognac", "liqueur", "absinthe", "vermouth", "cider", "sherry", "port", "amaretto", "baileys", "schnapps", "prosecco", "pinot noir", "merlot", "chardonnay", "sauvignon blanc", "pinot grigio", "rosé", "red wine", "white wine"]
