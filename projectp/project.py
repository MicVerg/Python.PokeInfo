...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # add list button
        self.button_1 = customtkinter.CTkButton(self.slider_progressbar_frame, text="Add a list", )
        self.button_1.grid(row=0, column=0, padx=(20, 10), pady=(10, 10), sticky="ew")
        # remove list button
        self.button_2 = customtkinter.CTkButton(self.slider_progressbar_frame, text="Remove a list")
